...
//        vo = (UserInfo) this.getIntent().getSerializableExtra("personalInfo");
//
//
//            TempRun();
    ...
    public void Cell_lay_Click(View v, int pos) {
        switch (pos) {
            case 0: {
                ...
                //游客
                if (MeiMengApp.isVisitor){
                    MeiMengApp.setVisitorDialogView(UserSettingActivity.this);
                }
